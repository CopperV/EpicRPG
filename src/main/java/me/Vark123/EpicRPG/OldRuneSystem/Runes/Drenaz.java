...
public class Drenaz extends ARune {
	...
	public void castSpell() {
		...
		p.getWorld().spawnParticle(Particle.DUST, p.getLocation().add(0,1,0), 12, 0.4f, 0.6f, 0.4f, 0.1f, dust);
	...
	private void playEffect(Entity e) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				loc.getWorld().spawnParticle(Particle.DUST, loc, 4, .2f, .2f, .2f, .1f, dust);

...
public class OdwrocenieUwagi extends ARune {
	...
	public void castSpell() {
		...
		p.getWorld().spawnParticle(Particle.LARGE_SMOKE, p.getLocation().clone().add(0,1,0), 25, 1, 1, 1, 0.2f);
		
		Location loc = p.getLocation();
		PotionEffect potion = new PotionEffect(PotionEffectType.SLOWNESS, 20*dr.getDurationTime(), 9);

...
public class TajemnyBlask_M extends ARune {
	...
	public void castSpell() {
		...
		.forEach(rpg -> {
			...
			debuff_tmp.add(_p);
			rpg.getModifiers().setTajemnyBlask_m(true);
			...
			new BukkitRunnable() {
				...
				public void run() {
					if(timer <= 0 || !casterInCastWorld() 
						...
						rpg.getModifiers().setTajemnyBlask_m(false);

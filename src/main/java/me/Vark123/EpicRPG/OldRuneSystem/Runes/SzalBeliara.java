	...
	public void castSpell() {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				p.getWorld().spawnParticle(Particle.DUST, loc2, 4, 0.1f, 0.1f, 0.1f, 0.02f, dust1);
				p.getWorld().spawnParticle(Particle.DUST, loc2, 4, 0f, 0f, 0f, 0.25f, dust2);
				...
				loc2.getWorld().getNearbyEntities(loc2, 3, 3, 3, e -> {
					...
					p.getWorld().spawnParticle(Particle.DUST, e.getLocation(), 15, 0.4f, 0.5f, 0.4f, 0.15f, dust1);
				});

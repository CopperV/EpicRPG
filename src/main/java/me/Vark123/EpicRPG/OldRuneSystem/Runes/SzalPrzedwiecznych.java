...
public class SzalPrzedwiecznych extends ARune {

	public SzalPrzedwiecznych(ItemStackRune dr, Player p) {
		super(dr, p);
		this.modifier1 = true;
	}
	...
	public void castSpell() {
		...
		modifiers.setSzalPrzedwiecznych(true);
		...
		new BukkitRunnable() {
			...
			public void run() {
				if(timer <= 0 || !casterInCastWorld()) {
					...
					modifiers.setSzalPrzedwiecznych(false);

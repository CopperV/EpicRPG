...
public class ZewSmierci_M extends ARune {
	...
	public ZewSmierci_M(ItemStackRune dr, Player p) {
		super(dr, p);
	}
	...
	public void castSpell() {
		...
		p.getWorld().spawnParticle(Particle.DUST, pLoc, 16, 0.45f, 0.8f, 0.45f, 0.15f, dust);
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				loc.getWorld().getNearbyEntities(loc, 3, 3, 3, e -> {
					...
					double amount = _p.getAttribute(Attribute.GENERIC_MAX_HEALTH).getValue()*0.06;

	...
	public void castSpell() {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				p.getWorld().spawnParticle(Particle.WITCH, loc2, 4, 0.1f, 0.1f, 0.1f, 0.08f);
				p.getWorld().spawnParticle(Particle.SMOKE, loc2, 4, 0.1f, 0.1f, 0.1f, 0.04f);
				...
				loc2.getWorld().getNearbyEntities(loc2, 3, 3, 3, e -> {
					...
					p.getWorld().spawnParticle(Particle.WITCH, e.getLocation(), 15, 0.4f, 0.5f, 0.4f, 0.15f);
				});

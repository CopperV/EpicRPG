	...
	public void castSpell() {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				p.getWorld().spawnParticle(Particle.DUST, loc.clone().add(x1,0,z1), 12, 0.15f, 0.15f, 0.15f, 0.04f, dust1);
				p.getWorld().spawnParticle(Particle.DUST, loc.clone().add(x2,0,z2), 12, 0.15f, 0.15f, 0.15f, 0.04f, dust2);
				p.getWorld().spawnParticle(Particle.DUST, loc.clone().add(0,y3,0), 12, 0.15f, 0.15f, 0.15f, 0.04f, dust3);

	...
	public void castSpell() {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				p.getWorld().spawnParticle(Particle.FIREWORK, loc2, 7, 0.1f, 0.1f, 0.1f, 0.05f);
				...
				loc.getWorld().getNearbyEntities(loc2, 3, 3, 3, e -> {
					...
					p.getWorld().spawnParticle(Particle.FIREWORK, e.getLocation(), 15, 0.4f, 0.5f, 0.4f, 0.15f);
				});

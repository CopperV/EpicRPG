...
public class RuneUtils {
	...
	public static void krewPrzodkowEffect(RpgPlayer rpg) {
		...
		if(!event.isCancelled())
			p.getWorld().spawnParticle(Particle.DUST, p.getLocation(), 10, 0.5F, 0.5F, 0.5F, 0.1f, new DustOptions(Color.fromRGB(154, 3, 67), 1.25f));
	}
					...
					public void playEffect(Player damager, LivingEntity victim, ItemStackRune ir) {
						new BukkitRunnable() {
							...
							public void run() {
								...
								victim.getWorld().spawnParticle(Particle.DUST, victim.getLocation().add(0,1,0), 8, 0.5f, 0.6f, 0.5f, 0.1f, dust);
							}
					...
					public void playEffect(Player damager, LivingEntity victim, ItemStackRune ir) {
						new BukkitRunnable() {
							...
							public void run() {
								...
								victim.getWorld().spawnParticle(Particle.ITEM_SLIME, victim.getLocation().add(0,1,0), 8, 0.5f, 0.6f, 0.5f, 0.1f);
							}

...
public class AttackLowestPercentageHpCommand extends ASummonCommand {

	public AttackLowestPercentageHpCommand() {
		super("attack_lowest_percentage_hp", new SummonCommandItem(Material.STICK, "§3Atakuj §7[§3Najnizszy % HP§7]", Arrays.asList(
	...
	public void apply(Player owner, ActiveMob summon) {
		...
		loc.getWorld().playSound(loc, Sound.ENTITY_BREEZE_CHARGE, 1.25f, 1.05f);
		...
		summon.setStance("attack_lowest_percentage_hp");

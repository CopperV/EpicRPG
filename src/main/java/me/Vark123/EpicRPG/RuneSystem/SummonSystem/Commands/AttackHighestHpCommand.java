...
public class AttackHighestHpCommand extends ASummonCommand {

	public AttackHighestHpCommand() {
		super("attack_highest_hp", new SummonCommandItem(Material.IRON_CHESTPLATE, "§3Atakuj §7[§3Najwiecej HP§7]", Arrays.asList(
	...
	public void apply(Player owner, ActiveMob summon) {
		...
		loc.getWorld().playSound(loc, Sound.ENTITY_BREEZE_SHOOT, 1.25f, 0.75f);
		...
		summon.setStance("attack_highest_hp");

...
public class CienAssasyna extends ACastableRune {

	private Random rand = new Random();
	
	public CienAssasyna(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.CIEN_ASSASYNA,
				player,
				target -> {
				...
				new TimingRuneEffect(4, target -> {
					...
					_loc.getWorld().spawnParticle(Particle.SMOKE, _loc, 4, 0.4f, 0.8f, 0.4f, force);
				}));
	}

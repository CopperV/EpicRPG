...
public class EksplodujacaStrzala_M extends ACastableRune {
	private static final Random rand = new Random();
	
	public EksplodujacaStrzala_M(RpgPlayer rpgPlayer, EpicRune rune, Collection<RuneLockerTypes> lockers) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.EKSPLODUJACA_STRZALA_M,
				player,
				target -> {

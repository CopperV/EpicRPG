...
public class LodowaWlocznia extends ACastableRune {

	private IRuneHitCondition hitCondition;
	private BoundingBox boundingBox;
	
	public LodowaWlocznia(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		...
		MultipleProjectileRuneTemplate.castProjectile(
				...
				boundingBox,
				loc -> {
					loc.getWorld().playSound(loc, Sound.BLOCK_AMETHYST_CLUSTER_BREAK, 1.2f, 0.7f);
				}, 
				loc -> {

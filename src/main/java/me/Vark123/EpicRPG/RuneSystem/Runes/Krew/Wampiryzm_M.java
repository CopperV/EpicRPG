...
public class Wampiryzm_M extends ACastableRune {
	
	private static final DustOptions dust = new DustOptions(Color.fromRGB(224, 32, 32), 0.8f);
	
	public Wampiryzm_M(RpgPlayer rpgPlayer, EpicRune rune, Collection<RuneLockerTypes> lockers) {

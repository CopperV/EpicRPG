...
public class PozeraczDusz_H extends ACastableRune {
	...
	public PozeraczDusz_H(RpgPlayer rpgPlayer, EpicRune rune) {
		...
		regenValue = (int) (1.1 * (0.04 * rpgPlayer.getInfo().getLevel() + 0.02 * stats.getFinalMana() + 0.1 * stats.getFinalInteligencja()));
	}

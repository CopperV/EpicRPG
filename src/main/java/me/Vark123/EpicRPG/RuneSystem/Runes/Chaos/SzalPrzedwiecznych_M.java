...
public class SzalPrzedwiecznych_M extends ACastableRune {

	private Random rand = new Random();
	
	public SzalPrzedwiecznych_M(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.SZAL_PRZEDWIECZNYCH_M,
				player,
				target -> {

...
public class SzalPrzedwiecznych_H extends ARune {

	public SzalPrzedwiecznych_H(ItemStackRune dr, Player p) {
		super(dr, p);
		this.modifier1 = true;
	}
	...
	public void castSpell() {
		...
		modifiers.setSzalPrzedwiecznych_h(true);
		...
		new BukkitRunnable() {
			...
			public void run() {
				if(timer <= 0 || !casterInCastWorld()) {
					...
					modifiers.setSzalPrzedwiecznych_h(false);

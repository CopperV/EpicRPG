...
public class Prowokacja extends ACastableRune {
	
	private IRuneHitCondition hitCondition;
	private Random rand = new Random();
	private PotionEffect potion;

	public Prowokacja(RpgPlayer rpgPlayer, EpicRune rune) {
		super(rpgPlayer, rune);
		
		hitCondition = new NonPvPRuneHitCondition();
		potion = new PotionEffect(PotionEffectType.SLOWNESS, 20*rune.getDurationTime(), 0);
	}

...
public class EksplodujacaStrzala extends ACastableRune {
	
	public EksplodujacaStrzala(RpgPlayer rpgPlayer, EpicRune rune, Collection<RuneLockerTypes> lockers) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.EKSPLODUJACA_STRZALA,
				player,
				target -> {

...
public class PozeraczDusz extends ACastableRune {
	...
	public PozeraczDusz(RpgPlayer rpgPlayer, EpicRune rune) {
		...
		regenValue = (int) (0.04 * rpgPlayer.getInfo().getLevel() + 0.02 * stats.getFinalMana() + 0.1 * stats.getFinalInteligencja());
	}

...
public class SwietaStrzalaLcz extends ACastableRune {

	private Random rand = new Random();
	
	public SwietaStrzalaLcz(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.SWIETA_STRZALA,
				player,
				target -> {
				...
				new TimingRuneEffect(4, target -> {
					...
					_loc.getWorld().spawnParticle(Particle.FIREWORK, _loc, 4, 0.4f, 0.9f, 0.4f, force);
				}));
	}

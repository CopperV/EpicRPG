...
public class CiosWPlecy extends ACastableRune {

	private Random rand = new Random();
	
	public CiosWPlecy(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.CIOS_W_PLECY,
				player,
				target -> {
				...
				new TimingRuneEffect(4, target -> {
					...
					_loc.getWorld().spawnParticle(Particle.RAID_OMEN, _loc, 4, 0.4f, 0.8f, 0.4f, force);
				}));
	}

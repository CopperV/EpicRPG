...
public class Gruboskornosc extends ACastableRune {
	private static final Random rand = new Random();
	
	public Gruboskornosc(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.GRUBOSKORNOSC,
				player,
				target -> {
				...
				new TimingRuneEffect(3, target -> {
					...
					_loc.getWorld().spawnParticle(Particle.COMPOSTER, _loc, 3, 0.4f, 0.9f, 0.4f, 0);
				}));
	}

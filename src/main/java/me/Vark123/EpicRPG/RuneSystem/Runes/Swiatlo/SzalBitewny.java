...
public class SzalBitewny extends ACastableRune {

	private Random rand = new Random();
	
	public SzalBitewny(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.SZAL_BITEWNY,
				player,
				target -> {
					target.getWorld().playSound(target.getLocation(), Sound.ENTITY_RAVAGER_ROAR, 1.2f, 1f);
				}, 
				target -> {

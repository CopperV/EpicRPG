...
public class WybraniecBeliara extends ACastableRune {

	private Random rand = new Random();
	
	public WybraniecBeliara(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				this,
				rune.getName(),
				EpicModifierTypes.WYBRANIEC_BELIARA,
				player,
				target -> {
				...
				new TimingRuneEffect(4, target -> {
					...
					_loc.getWorld().spawnParticle(Particle.TRIAL_OMEN, _loc, 4, 0.4f, 0.8f, 0.4f, force);
				}));
	}

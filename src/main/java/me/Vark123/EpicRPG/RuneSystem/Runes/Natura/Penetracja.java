...
public class Penetracja extends ACastableRune {

	private Random rand = new Random();
	
	public Penetracja(RpgPlayer rpgPlayer, EpicRune rune) {
	...
	public void castSpell() {
		BufferRuneTemplate.castEffect(
				...
				new TimingRuneEffect(4, target -> {
					...
					_loc.getWorld().spawnParticle(Particle.CRIT, _loc, 2, 0.4f, 0.9f, 0.4f, force);
				}));
	}

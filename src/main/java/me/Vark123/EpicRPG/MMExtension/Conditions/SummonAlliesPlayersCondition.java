...
public class SummonAlliesPlayersCondition extends SkillCondition implements IEntityComparisonCondition {
	...
	public SummonAlliesPlayersCondition(final String line, final MythicLineConfig mlc) {
		super(line);
	}

	@Override
	public boolean check(AbstractEntity aCaster, AbstractEntity aEntity) {
		if(aCaster.equals(aEntity))
			return false;

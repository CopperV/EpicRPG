...
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.GniewNiedzwiedziaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.GrobowyZniwiarzSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.KarczemnyMoczymordaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.KlusownikSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.LodowyKaplanSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.MagicznaZagladaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.MagiczneWsparcieSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.MlodyAdeptSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.MroznaZamiecSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.NajemnikAraxosSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.NietykalnyNiezwyciezonySetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.NocWilkaSetListener;
...
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.PaladynPrawdySetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.PolnocnyBarbarzyncaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.RojalistaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.RunicznaMagiaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.RunicznyEgzekutorSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.RycerzSwiatlosciSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.StalowaOchronaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.StrazMiejskaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.SzalNiedzwiedziaSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.TemplariuszSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.TropicielSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.WiecznyWedrowiecSetListener;
import me.Vark123.EpicRPG.FightSystem.EffectListeners.Sets.WodnyKragSetListener;
...
import me.Vark123.EpicRPG.Stats.Listeners.OstatniBojStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.PrzyplywEnergiiStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetBizuteriaMagaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetBizuteriaMysliwegoStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetBizuteriaWojownikaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetBogatyMieszczaninStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetCeremonialArcholosStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetChlopiaSilaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetChodzacyTankStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetCzarnaOchronaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetFilozofStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetGniewNiedzwiedziaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetKarczemnyMoczymordaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetKlusownikStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetKrowiRzeznikStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetLodowyKaplanStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetMagicznaZagladaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetMagiczneWsparcieStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetMagiczneZrodloStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetMlodyAdeptStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetMorderczyMysliwyStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetNajemnikAraxosStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetNocWilkaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetNordmarczykStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetPaladynPrawdyStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetPiesnLoduStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetPokazSilyStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetPrzyjacielDruidowStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetRojalistaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetRunicznaMagiaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetRycerzSwiatlosciStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetSnieznyTropicielStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetStalowaOchronaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetStrazMiejskaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetSzalNiedzwiedziaStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetTemplariuszStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetTropicielArcholosStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetTropicielStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetUczenRaczkiStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetUtalentowanyUmyslStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetWodnyKragStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetWyspiarskiMysliwyStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SetZiraelStatChangeListener;
import me.Vark123.EpicRPG.Stats.Listeners.SzostyZmyslStatChangeListener;
...
//		Bukkit.getPluginManager().registerEvents(new PotionDrinkEvent(), inst);
		...
		Bukkit.getPluginManager().registerEvents(new FilozofSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new GniewNiedzwiedziaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new KarczemnyMoczymordaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new KlusownikSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new LodowyKaplanSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new MagicznaZagladaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new MagiczneWsparcieSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new MlodyAdeptSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new NajemnikAraxosSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new NietykalnyNiezwyciezonySetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new NocWilkaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new PaladynPrawdySetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new PolnocnyBarbarzyncaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new RojalistaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new RunicznaMagiaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new RycerzSwiatlosciSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new StalowaOchronaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new StrazMiejskaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SzalNiedzwiedziaSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new TemplariuszSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new TropicielSetListener(), inst);
		Bukkit.getPluginManager().registerEvents(new WodnyKragSetListener(), inst);

		Bukkit.getPluginManager().registerEvents(new SetBogatyMieszczaninDodgeCalcListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetMorderczyMysliwyPierceCalcListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetWyspiarskiMysliwyPierceCalcListener(), inst);
		
		Bukkit.getPluginManager().registerEvents(new OstatniBojStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new PrzyplywEnergiiStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SzostyZmyslStatChangeListener(), inst);

		Bukkit.getPluginManager().registerEvents(new SetBizuteriaMagaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetBizuteriaMysliwegoStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetBizuteriaWojownikaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetBogatyMieszczaninStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetCeremonialArcholosStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetChlopiaSilaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetChodzacyTankStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetCzarnaOchronaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetFilozofStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetGniewNiedzwiedziaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetKarczemnyMoczymordaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetKlusownikStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetKrowiRzeznikStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetLodowyKaplanStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetMagicznaZagladaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetMagiczneWsparcieStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetMagiczneZrodloStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetMlodyAdeptStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetMorderczyMysliwyStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetNajemnikAraxosStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetNocWilkaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetNordmarczykStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetPaladynPrawdyStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetPiesnLoduStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetPokazSilyStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetPrzyjacielDruidowStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetRojalistaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetRunicznaMagiaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetRycerzSwiatlosciStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetSnieznyTropicielStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetStalowaOchronaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetStrazMiejskaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetSzalNiedzwiedziaStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetTemplariuszStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetTropicielArcholosStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetTropicielStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetUczenRaczkiStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetUtalentowanyUmyslStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetWodnyKragStatChangeListener(), inst);
		Bukkit.getPluginManager().registerEvents(new SetWyspiarskiMysliwyStatChangeListener(), inst);
		...
		Bukkit.getPluginManager().registerEvents(new SummonLevelCalcByStatsListener(), inst);

...
@Getter
public class EpicAttackEvent extends AEpicDamageEvent {

	private static final HandlerList handlers = new HandlerList();

	public EpicAttackEvent(LivingEntity damager, LivingEntity victim, DamageSource damageSource, DamageType damageType,

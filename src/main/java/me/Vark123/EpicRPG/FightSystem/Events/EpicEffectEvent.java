...
@Getter
public class EpicEffectEvent extends AEpicFightEvent implements Cancellable {
	...
	public EpicEffectEvent(Entity damager, Entity victim, EpicDamageType damageType, double dmg, double modifier,

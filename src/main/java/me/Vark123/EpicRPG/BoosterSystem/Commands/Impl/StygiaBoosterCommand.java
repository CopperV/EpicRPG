...
public class StygiaBoosterCommand extends ABoostCommand {

	public StygiaBoosterCommand() {
		super("stygia", new String[] {});
	}
	...
	public void showCorrectUsage(CommandSender sender) {
		sender.sendMessage("  /epicboost stygia <player> <modifier> <seconds>");
	}

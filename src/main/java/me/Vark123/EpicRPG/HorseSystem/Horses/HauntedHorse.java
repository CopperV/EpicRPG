...
public class HauntedHorse extends AEpicHorse {

	public HauntedHorse() {
		super(Horse.class, 400., 0.6);
	}
	...
	public ItemStack getMenuMountItem() {
		ItemStack it = new ItemStack(Material.BONE_BLOCK);
		
		ItemMeta im = it.getItemMeta();
		im.setDisplayName("§3Upiorny Wierzchowiec");

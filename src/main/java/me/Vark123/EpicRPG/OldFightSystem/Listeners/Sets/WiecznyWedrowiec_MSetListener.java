...
public class WiecznyWedrowiec_MSetListener implements Listener {
	...
	private static final PotionEffect slowEffect = new PotionEffect(PotionEffectType.SLOWNESS, 20*6, 1);
	...
	public void slowDonwEnemyEffect(EpicEffectEvent e) {
		...
		int amount = info.getSetCounts().getOrDefault("Wieczny_Wedrowiec_M", 0);
		if(amount < 2)
			return;

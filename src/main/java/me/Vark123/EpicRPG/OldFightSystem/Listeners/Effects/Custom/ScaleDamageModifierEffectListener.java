package me.Vark123.EpicRPG.OldFightSystem.Listeners.Effects.Custom;
...
public class ScaleDamageModifierEffectListener implements Listener {
	...
	private static final double MAG_SCALE = 1;
	private static final double WOJ_SCALE = 0.65;
	private static final double MYS_SCALE = 0.54;

...
public class WiecznyWedrowiec_HSetListener implements Listener {
	...
	private static final PotionEffect slowEffect = new PotionEffect(PotionEffectType.SLOWNESS, 20*5, 0);
	...
	public void slowDonwEnemyEffect(EpicEffectEvent e) {
		...
		int amount = info.getSetCounts().getOrDefault("Wieczny_Wedrowiec_H", 0);
		if(amount < 2)
			return;
